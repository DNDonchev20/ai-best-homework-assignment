<template>
  <div
    class="mb-14 flex min-h-[260px] w-full content-between border-2 border-solid pb-7 pl-7 pt-5 shadow-xl"
  >
    <div>
      <h2 class="pb-4 text-2xl font-semibold">{{ title }}</h2>
      <p class="w-4/5 text-lg">Description: {{ description }}</p>
    </div>
    <div class="ml-auto mr-4 flex flex-col items-end justify-between">
      <div>
